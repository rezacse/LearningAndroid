...
public class NavigationDrawerHelper {
    ...
    public void init(Activity theActivity, ListView.OnItemClickListener listener) {
        ...
        String[] navigationDrawerOptions = theActivity.getResources().getStringArray(R.array.navigation_drawer_options);
        ArrayAdapter<String> navigationDrawerAdapter = new ArrayAdapter<String>(theActivity, R.layout.drawer_option_item, navigationDrawerOptions);
    ...
    private void setupActionBar(Activity theActivity) {
        ...
        ActionBar actionBar = ((AppCompatActivity) theActivity).getSupportActionBar();// theActivity.getActionBar();
        //((AppCompatActivity)theActivity).getSupportActionBar().setDisplayHomeAsUpEnabled(true);
